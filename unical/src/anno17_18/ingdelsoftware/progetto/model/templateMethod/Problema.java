package anno17_18.ingdelsoftware.progetto.model.templateMethod;

public abstract class Problema<P, S> {	// P = punto di scelta ; S = scelta 
	...
	protected int nummaxsoluzioni, nrsoluzione = 0;
